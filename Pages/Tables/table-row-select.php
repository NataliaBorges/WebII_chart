                                        ...
                                        <table id="row-select" class="display table table-borderd table-hover">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 18px !important;"><?php echo $Genero['Titulo']; ?></td>
                                                    <td style="padding-left: 18px !important;"><?php echo $Genero['Edicao']; ?></td>
                                                    <td style="padding-left: 18px !important;"><?php echo $Genero['Ano_Publicacao']; ?></td>
                                                    <td style="padding-left: 18px !important;"><?php echo $Genero['ISBN']; ?></td>
                                                    <td style="padding-left: 18px !important;"><?php echo $Genero['Nome_Autor']; ?></td>
                                                    <td style="padding-left: 18px !important;"><?php echo $Genero['Nome_Editora']; ?></td>
