          ...
          <ul>
            ...
            <li><a class="sidebar-sub-toggle"><i class="ti-view-list-alt"></i> Relatório <span class="sidebar-collapse-icon ti-angle-down"></span></a>
              <ul>
                ...
                <li><a href="/Pages/Tables/Genero.php">Gênero</a></li>
                <li><a href="/Pages/Tables/Leitor.php">Leitor</a></li>
                <li><a href="/Pages/Tables/Funcionario.php">Funcionário</a></li>
                <li><a href="/Pages/Tables/Emprestimo.php">Emprestimo</a></li>
              </ul>
            </li>
        </div>
      </div>
